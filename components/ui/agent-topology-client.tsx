...
const AgentTopology = dynamic(
  ...
  {
    ssr: false,
    loading: () => <div className="h-full min-h-[140px] w-full skeleton rounded-2xl" />,
  }
);
 ...
 */
export function AgentTopologyClient({
  agents,
  teamMap,
}: {
  ...
  return <AgentTopology agents={agents} teamMap={teamMap} />;
}
