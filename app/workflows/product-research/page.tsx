...
const dataSources = [
  { id: "amazon", name: "Amazon 前台", icon: <ShoppingCart className="h-4 w-4" />, color: "text-orange-400", enabled: true, status: "completed" as const, progress: 100 },
  { id: "tiktok", name: "TikTok", icon: <Zap className="h-4 w-4" />, color: "text-pink-400", enabled: true, status: "completed" as const, progress: 100 },
  { id: "youtube", name: "YouTube", icon: <Video className="h-4 w-4" />, color: "text-red-400", enabled: true, status: "scraping" as const, progress: 67 },
  { id: "1688", name: "1688", icon: <Factory className="h-4 w-4" />, color: "text-amber-400", enabled: true, status: "completed" as const, progress: 100 },
  { id: "sif", name: "SIF", icon: <BarChart3 className="h-4 w-4" />, color: "text-blue-400", enabled: true, status: "completed" as const, progress: 100 },
  { id: "sellerSprite", name: "卖家精灵", icon: <Star className="h-4 w-4" />, color: "text-emerald-400", enabled: true, status: "scraping" as const, progress: 45 },
  { id: "fastmoss", name: "Fastmoss", icon: <Globe className="h-4 w-4" />, color: "text-cyan-400", enabled: false, status: "pending" as const, progress: 0 },
  { id: "googleTrends", name: "Google Trends", icon: <TrendingUp className="h-4 w-4" />, color: "text-indigo-400", enabled: true, status: "completed" as const, progress: 100 },
  { id: "patent", name: "专利检索", icon: <ShieldAlert className="h-4 w-4" />, color: "text-red-400", enabled: true, status: "completed" as const, progress: 100 },
];

const keywords = [
  { keyword: "pet water fountain", volume: 48200, cpc: 1.23, competition: 0.82, supplyDemand: 2.4, trend: [40, 45, 42, 50, 55, 58, 62], aiTag: "potential" as const },
  { keyword: "automatic cat feeder", volume: 35600, cpc: 1.45, competition: 0.91, supplyDemand: 1.8, trend: [30, 32, 35, 34, 38, 40, 42], aiTag: "competitive" as const },
  { keyword: "interactive cat toy", volume: 22100, cpc: 0.87, competition: 0.56, supplyDemand: 3.1, trend: [20, 22, 28, 32, 35, 38, 45], aiTag: "potential" as const },
  { keyword: "cat grooming brush", volume: 18500, cpc: 0.65, competition: 0.42, supplyDemand: 2.8, trend: [18, 20, 19, 22, 25, 28, 30], aiTag: "potential" as const },
  { keyword: "smart pet camera", volume: 28900, cpc: 2.10, competition: 0.95, supplyDemand: 1.2, trend: [35, 30, 28, 25, 22, 20, 18], aiTag: "risky" as const },
  { keyword: "dog puzzle toy", volume: 15800, cpc: 0.72, competition: 0.48, supplyDemand: 3.5, trend: [15, 18, 22, 25, 28, 30, 35], aiTag: "potential" as const },
  { keyword: "cat tree tower", volume: 52300, cpc: 1.85, competition: 0.94, supplyDemand: 1.5, trend: [48, 50, 52, 50, 48, 45, 43], aiTag: "competitive" as const },
  { keyword: "pet nail clipper", volume: 12400, cpc: 0.55, competition: 0.35, supplyDemand: 4.2, trend: [10, 12, 14, 15, 18, 20, 22], aiTag: "potential" as const },
];
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <span className={ds.color}>{ds.icon}</span>
